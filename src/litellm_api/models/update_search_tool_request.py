...
T = TypeVar("T", bound="UpdateSearchToolRequest")
...
class UpdateSearchToolRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_search_tool_request = cls(
            search_tool=search_tool,
        )


        update_search_tool_request.additional_properties = d
        return update_search_tool_request
