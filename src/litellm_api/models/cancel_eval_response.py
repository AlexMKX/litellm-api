...
T = TypeVar("T", bound="CancelEvalResponse")



@_attrs_define
class CancelEvalResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_eval_response.additional_properties = d
        return cancel_eval_response
