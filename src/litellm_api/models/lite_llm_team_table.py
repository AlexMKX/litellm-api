...
class LiteLLMTeamTable:
    """ 
        Attributes:
            ...
            metadata (LiteLLMTeamTableMetadataType0 | None | Unset):
    ...
    metadata: LiteLLMTeamTableMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.router_settings, LiteLLMTeamTableRouterSettingsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> LiteLLMTeamTableMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(LiteLLMTeamTableMetadataType0 | None | Unset, data)
        ...
        def _parse_router_settings(data: object) -> LiteLLMTeamTableRouterSettingsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                router_settings_type_0 = LiteLLMTeamTableRouterSettingsType0.from_dict(data)
                ...
                pass
            return cast(LiteLLMTeamTableRouterSettingsType0 | None | Unset, data)
