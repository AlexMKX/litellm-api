...
T = TypeVar("T", bound="ChatCompletionChatCompletionsPostBody")



@_attrs_define
class ChatCompletionChatCompletionsPostBody:
    """ 
        Attributes:
            model (str):
            ...
            logit_bias (ChatCompletionChatCompletionsPostBodyLogitBiasType0 | None | Unset):
            logprobs (bool | None | Unset):
            top_logprobs (int | None | Unset):
            max_tokens (int | None | Unset):
            n (int | None | Unset):
            presence_penalty (float | None | Unset):
            response_format (ChatCompletionChatCompletionsPostBodyResponseFormatType0 | None | Unset):
            seed (int | None | Unset):
            service_tier (None | str | Unset):
            stop (list[str] | None | str | Unset):
            stream_options (ChatCompletionChatCompletionsPostBodyStreamOptionsType0 | None | Unset):
            temperature (float | None | Unset):
            top_p (float | None | Unset):
            tools (list[ChatCompletionChatCompletionsPostBodyToolsType0Item] | None | Unset):
            tool_choice (ChatCompletionChatCompletionsPostBodyToolChoiceType1 | None | str | Unset):
            parallel_tool_calls (bool | None | Unset):
            function_call (ChatCompletionChatCompletionsPostBodyFunctionCallType1 | None | str | Unset):
            functions (list[ChatCompletionChatCompletionsPostBodyFunctionsType0Item] | None | Unset):
            user (None | str | Unset):
            stream (bool | None | Unset):
            metadata (ChatCompletionChatCompletionsPostBodyMetadataType0 | None | Unset):
            guardrails (list[str] | None | Unset):
            caching (bool | None | Unset):
            num_retries (int | None | Unset):
            context_window_fallback_dict (ChatCompletionChatCompletionsPostBodyContextWindowFallbackDictType0 | None |
                Unset):
    ...
    logit_bias: ChatCompletionChatCompletionsPostBodyLogitBiasType0 | None | Unset = UNSET
    ...
    response_format: ChatCompletionChatCompletionsPostBodyResponseFormatType0 | None | Unset = UNSET
    seed: int | None | Unset = UNSET
    service_tier: None | str | Unset = UNSET
    stop: list[str] | None | str | Unset = UNSET
    stream_options: ChatCompletionChatCompletionsPostBodyStreamOptionsType0 | None | Unset = UNSET
    temperature: float | None | Unset = UNSET
    top_p: float | None | Unset = UNSET
    tools: list[ChatCompletionChatCompletionsPostBodyToolsType0Item] | None | Unset = UNSET
    tool_choice: ChatCompletionChatCompletionsPostBodyToolChoiceType1 | None | str | Unset = UNSET
    parallel_tool_calls: bool | None | Unset = UNSET
    function_call: ChatCompletionChatCompletionsPostBodyFunctionCallType1 | None | str | Unset = UNSET
    functions: list[ChatCompletionChatCompletionsPostBodyFunctionsType0Item] | None | Unset = UNSET
    user: None | str | Unset = UNSET
    stream: bool | None | Unset = UNSET
    metadata: ChatCompletionChatCompletionsPostBodyMetadataType0 | None | Unset = UNSET
    guardrails: list[str] | None | Unset = UNSET
    caching: bool | None | Unset = UNSET
    num_retries: int | None | Unset = UNSET
    context_window_fallback_dict: ChatCompletionChatCompletionsPostBodyContextWindowFallbackDictType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.logit_bias, Unset):
            logit_bias = UNSET
        elif isinstance(self.logit_bias, ChatCompletionChatCompletionsPostBodyLogitBiasType0):
        ...
        elif isinstance(self.response_format, ChatCompletionChatCompletionsPostBodyResponseFormatType0):
        ...
        elif isinstance(self.stream_options, ChatCompletionChatCompletionsPostBodyStreamOptionsType0):
        ...
        if isinstance(self.tool_choice, Unset):
            tool_choice = UNSET
        elif isinstance(self.tool_choice, ChatCompletionChatCompletionsPostBodyToolChoiceType1):
        ...
        if isinstance(self.function_call, Unset):
            function_call = UNSET
        elif isinstance(self.function_call, ChatCompletionChatCompletionsPostBodyFunctionCallType1):
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, ChatCompletionChatCompletionsPostBodyMetadataType0):
        ...
        elif isinstance(self.context_window_fallback_dict, ChatCompletionChatCompletionsPostBodyContextWindowFallbackDictType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_logit_bias(data: object) -> ChatCompletionChatCompletionsPostBodyLogitBiasType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                logit_bias_type_0 = ChatCompletionChatCompletionsPostBodyLogitBiasType0.from_dict(data)
                ...
                pass
            return cast(ChatCompletionChatCompletionsPostBodyLogitBiasType0 | None | Unset, data)
        ...
        def _parse_response_format(data: object) -> ChatCompletionChatCompletionsPostBodyResponseFormatType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_format_type_0 = ChatCompletionChatCompletionsPostBodyResponseFormatType0.from_dict(data)
                ...
                pass
            return cast(ChatCompletionChatCompletionsPostBodyResponseFormatType0 | None | Unset, data)
        ...
        def _parse_stream_options(data: object) -> ChatCompletionChatCompletionsPostBodyStreamOptionsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                stream_options_type_0 = ChatCompletionChatCompletionsPostBodyStreamOptionsType0.from_dict(data)
                ...
                pass
            return cast(ChatCompletionChatCompletionsPostBodyStreamOptionsType0 | None | Unset, data)
        ...
        def _parse_tools(data: object) -> list[ChatCompletionChatCompletionsPostBodyToolsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tools_type_0_item_data in (_tools_type_0):
                    tools_type_0_item = ChatCompletionChatCompletionsPostBodyToolsType0Item.from_dict(tools_type_0_item_data)
                ...
                pass
            return cast(list[ChatCompletionChatCompletionsPostBodyToolsType0Item] | None | Unset, data)

        tools = _parse_tools(d.pop("tools", UNSET))


        def _parse_tool_choice(data: object) -> ChatCompletionChatCompletionsPostBodyToolChoiceType1 | None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                tool_choice_type_1 = ChatCompletionChatCompletionsPostBodyToolChoiceType1.from_dict(data)
                ...
                pass
            return cast(ChatCompletionChatCompletionsPostBodyToolChoiceType1 | None | str | Unset, data)
        ...
        def _parse_function_call(data: object) -> ChatCompletionChatCompletionsPostBodyFunctionCallType1 | None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                function_call_type_1 = ChatCompletionChatCompletionsPostBodyFunctionCallType1.from_dict(data)
                ...
                pass
            return cast(ChatCompletionChatCompletionsPostBodyFunctionCallType1 | None | str | Unset, data)

        function_call = _parse_function_call(d.pop("function_call", UNSET))


        def _parse_functions(data: object) -> list[ChatCompletionChatCompletionsPostBodyFunctionsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for functions_type_0_item_data in (_functions_type_0):
                    functions_type_0_item = ChatCompletionChatCompletionsPostBodyFunctionsType0Item.from_dict(functions_type_0_item_data)
                ...
                pass
            return cast(list[ChatCompletionChatCompletionsPostBodyFunctionsType0Item] | None | Unset, data)
        ...
        def _parse_metadata(data: object) -> ChatCompletionChatCompletionsPostBodyMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = ChatCompletionChatCompletionsPostBodyMetadataType0.from_dict(data)
                ...
                pass
            return cast(ChatCompletionChatCompletionsPostBodyMetadataType0 | None | Unset, data)
        ...
        def _parse_context_window_fallback_dict(data: object) -> ChatCompletionChatCompletionsPostBodyContextWindowFallbackDictType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                context_window_fallback_dict_type_0 = ChatCompletionChatCompletionsPostBodyContextWindowFallbackDictType0.from_dict(data)
                ...
                pass
            return cast(ChatCompletionChatCompletionsPostBodyContextWindowFallbackDictType0 | None | Unset, data)
        ...
        chat_completion_chat_completions_post_body = cls(
            model=model,
            messages=messages,
        ...
        chat_completion_chat_completions_post_body.additional_properties = d
        return chat_completion_chat_completions_post_body
