...
class MemoryCreateRequest:
    """ 
        Attributes:
            key (str): Memory key (acts as the namespace in the URL).
            value (str): Memory content. Typically markdown/text for LLM context.
            metadata (Any | None | Unset): Optional JSON metadata (tags, structured fields).
            user_id (None | str | Unset): Scope to this user. Defaults to the caller's user_id.
            team_id (None | str | Unset): Scope to this team. Defaults to the caller's team_id.
     """
