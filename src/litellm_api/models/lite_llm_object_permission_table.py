...
if TYPE_CHECKING:
  from ..models.lite_llm_object_permission_table_mcp_tool_permissions_type_0 import LiteLLMObjectPermissionTableMcpToolPermissionsType0





T = TypeVar("T", bound="LiteLLMObjectPermissionTable")



@_attrs_define
class LiteLLMObjectPermissionTable:
    """ Represents a LiteLLM_ObjectPermissionTable record
        ...
        Attributes:
            ...
            mcp_tool_permissions (LiteLLMObjectPermissionTableMcpToolPermissionsType0 | None | Unset):
    ...
    mcp_tool_permissions: LiteLLMObjectPermissionTableMcpToolPermissionsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.mcp_tool_permissions, LiteLLMObjectPermissionTableMcpToolPermissionsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.lite_llm_object_permission_table_mcp_tool_permissions_type_0 import LiteLLMObjectPermissionTableMcpToolPermissionsType0
        d = dict(src_dict)
        object_permission_id = d.pop("object_permission_id")
        ...
        def _parse_mcp_tool_permissions(data: object) -> LiteLLMObjectPermissionTableMcpToolPermissionsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                mcp_tool_permissions_type_0 = LiteLLMObjectPermissionTableMcpToolPermissionsType0.from_dict(data)
                ...
                pass
            return cast(LiteLLMObjectPermissionTableMcpToolPermissionsType0 | None | Unset, data)
        ...
        lite_llm_object_permission_table.additional_properties = d
        return lite_llm_object_permission_table
