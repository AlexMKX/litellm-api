...
if TYPE_CHECKING:
  ...
  from ..models.team_list_item_metadata_type_0 import TeamListItemMetadataType0
  from ..models.team_list_item_router_settings_type_0 import TeamListItemRouterSettingsType0





T = TypeVar("T", bound="TeamListItem")
...
class TeamListItem:
    """ A team item in the paginated list response, enriched with computed fields.
        ...
        Attributes:
            ...
            metadata (None | TeamListItemMetadataType0 | Unset):
    ...
    metadata: None | TeamListItemMetadataType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, TeamListItemMetadataType0):
        ...
        elif isinstance(self.router_settings, TeamListItemRouterSettingsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> None | TeamListItemMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = TeamListItemMetadataType0.from_dict(data)
                ...
                pass
            return cast(None | TeamListItemMetadataType0 | Unset, data)
        ...
        def _parse_router_settings(data: object) -> None | TeamListItemRouterSettingsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                router_settings_type_0 = TeamListItemRouterSettingsType0.from_dict(data)
                ...
                pass
            return cast(None | TeamListItemRouterSettingsType0 | Unset, data)
        ...
        team_list_item.additional_properties = d
        return team_list_item
