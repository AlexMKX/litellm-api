...
T = TypeVar("T", bound="UpdateLiteLLMParams")



@_attrs_define
class UpdateLiteLLMParams:
    """ 
        Attributes:
            ...
            search_context_cost_per_query (None | Unset | UpdateLiteLLMParamsSearchContextCostPerQueryType0):
            citation_cost_per_token (float | None | Unset):
            tiered_pricing (list[UpdateLiteLLMParamsTieredPricingType0Item] | None | Unset):
            api_key (None | str | Unset):
            api_base (None | str | Unset):
            api_version (None | str | Unset):
            vertex_project (None | str | Unset):
            vertex_location (None | str | Unset):
            vertex_credentials (None | str | Unset | UpdateLiteLLMParamsVertexCredentialsType1):
    ...
    search_context_cost_per_query: None | Unset | UpdateLiteLLMParamsSearchContextCostPerQueryType0 = UNSET
    citation_cost_per_token: float | None | Unset = UNSET
    tiered_pricing: list[UpdateLiteLLMParamsTieredPricingType0Item] | None | Unset = UNSET
    ...
    vertex_credentials: None | str | Unset | UpdateLiteLLMParamsVertexCredentialsType1 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.search_context_cost_per_query, UpdateLiteLLMParamsSearchContextCostPerQueryType0):
        ...
        elif isinstance(self.vertex_credentials, UpdateLiteLLMParamsVertexCredentialsType1):
        ...
        if isinstance(self.model_info, Unset):
            model_info = UNSET
        elif isinstance(self.model_info, UpdateLiteLLMParamsModelInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_context_cost_per_query(data: object) -> None | Unset | UpdateLiteLLMParamsSearchContextCostPerQueryType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                search_context_cost_per_query_type_0 = UpdateLiteLLMParamsSearchContextCostPerQueryType0.from_dict(data)
                ...
                pass
            return cast(None | Unset | UpdateLiteLLMParamsSearchContextCostPerQueryType0, data)
        ...
        def _parse_tiered_pricing(data: object) -> list[UpdateLiteLLMParamsTieredPricingType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tiered_pricing_type_0_item_data in (_tiered_pricing_type_0):
                    tiered_pricing_type_0_item = UpdateLiteLLMParamsTieredPricingType0Item.from_dict(tiered_pricing_type_0_item_data)
                ...
                pass
            return cast(list[UpdateLiteLLMParamsTieredPricingType0Item] | None | Unset, data)
        ...
        def _parse_vertex_credentials(data: object) -> None | str | Unset | UpdateLiteLLMParamsVertexCredentialsType1:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                vertex_credentials_type_1 = UpdateLiteLLMParamsVertexCredentialsType1.from_dict(data)
                ...
                pass
            return cast(None | str | Unset | UpdateLiteLLMParamsVertexCredentialsType1, data)
        ...
        def _parse_model_info(data: object) -> None | Unset | UpdateLiteLLMParamsModelInfoType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                model_info_type_0 = UpdateLiteLLMParamsModelInfoType0.from_dict(data)
                ...
                pass
            return cast(None | Unset | UpdateLiteLLMParamsModelInfoType0, data)
        ...
        update_lite_llm_params.additional_properties = d
        return update_lite_llm_params
