...
T = TypeVar("T", bound="EmailEventSettingsUpdateRequest")



@_attrs_define
class EmailEventSettingsUpdateRequest:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        email_event_settings_update_request = cls(
            settings=settings,
        )


        email_event_settings_update_request.additional_properties = d
        return email_event_settings_update_request
