...
T = TypeVar("T", bound="NewProjectResponse")
...
class NewProjectResponse:
    """ Response model for POST /project/new
        ...
        Attributes:
            ...
            metadata (NewProjectResponseMetadataType0 | None | Unset):
            models (list[str] | Unset):
            spend (float | Unset):  Default: 0.0.
            model_spend (NewProjectResponseModelSpendType0 | None | Unset):
            model_rpm_limit (NewProjectResponseModelRpmLimitType0 | None | Unset):
    ...
    metadata: NewProjectResponseMetadataType0 | None | Unset = UNSET
    models: list[str] | Unset = UNSET
    spend: float | Unset = 0.0
    model_spend: NewProjectResponseModelSpendType0 | None | Unset = UNSET
    model_rpm_limit: NewProjectResponseModelRpmLimitType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, NewProjectResponseMetadataType0):
        ...
        if isinstance(self.model_spend, Unset):
            model_spend = UNSET
        elif isinstance(self.model_spend, NewProjectResponseModelSpendType0):
        ...
        elif isinstance(self.model_rpm_limit, NewProjectResponseModelRpmLimitType0):
        ...
        elif isinstance(self.model_tpm_limit, NewProjectResponseModelTpmLimitType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> NewProjectResponseMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = NewProjectResponseMetadataType0.from_dict(data)
                ...
                pass
            return cast(NewProjectResponseMetadataType0 | None | Unset, data)
        ...
        def _parse_model_spend(data: object) -> NewProjectResponseModelSpendType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                model_spend_type_0 = NewProjectResponseModelSpendType0.from_dict(data)
                ...
                pass
            return cast(NewProjectResponseModelSpendType0 | None | Unset, data)

        model_spend = _parse_model_spend(d.pop("model_spend", UNSET))


        def _parse_model_rpm_limit(data: object) -> NewProjectResponseModelRpmLimitType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                model_rpm_limit_type_0 = NewProjectResponseModelRpmLimitType0.from_dict(data)
                ...
                pass
            return cast(NewProjectResponseModelRpmLimitType0 | None | Unset, data)

        model_rpm_limit = _parse_model_rpm_limit(d.pop("model_rpm_limit", UNSET))


        def _parse_model_tpm_limit(data: object) -> NewProjectResponseModelTpmLimitType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                model_tpm_limit_type_0 = NewProjectResponseModelTpmLimitType0.from_dict(data)
                ...
                pass
            return cast(NewProjectResponseModelTpmLimitType0 | None | Unset, data)
        ...
        new_project_response.additional_properties = d
