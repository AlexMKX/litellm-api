...
T = TypeVar("T", bound="ChatCompletionSystemMessage")
...
class ChatCompletionSystemMessage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_completion_system_message = cls(
            role=role,
            content=content,
            name=name,
        ...
        chat_completion_system_message.additional_properties = d
        return chat_completion_system_message
