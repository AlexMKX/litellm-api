...
class Member:
    """ 
        Attributes:
            role (MemberRole): The role of the user within the team. 'admin' users can manage team settings and members,
                'user' is a regular team member
            user_id (None | str | Unset): The unique ID of the user to add. Either user_id or user_email must be provided
            user_email (None | str | Unset): The email address of the user to add. Either user_id or user_email must be
                provided
     """
