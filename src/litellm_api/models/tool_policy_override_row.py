...
T = TypeVar("T", bound="ToolPolicyOverrideRow")



@_attrs_define
class ToolPolicyOverrideRow:
    """ 
        Attributes:
            override_id (str):
            tool_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        input_policy: ToolPolicyOverrideRowInputPolicy | Unset
        if isinstance(_input_policy,  Unset):
            input_policy = UNSET
        else:
            input_policy = ToolPolicyOverrideRowInputPolicy(_input_policy)
        ...
        tool_policy_override_row.additional_properties = d
        return tool_policy_override_row
