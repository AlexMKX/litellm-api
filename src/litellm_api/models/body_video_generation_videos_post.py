...
T = TypeVar("T", bound="BodyVideoGenerationVideosPost")
...
class BodyVideoGenerationVideosPost:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_video_generation_videos_post = cls(
            input_reference=input_reference,
        )


        body_video_generation_videos_post.additional_properties = d
        return body_video_generation_videos_post
