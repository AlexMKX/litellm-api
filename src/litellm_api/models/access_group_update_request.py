...
T = TypeVar("T", bound="AccessGroupUpdateRequest")



@_attrs_define
class AccessGroupUpdateRequest:
    """ 
        Attributes:
            access_group_name (None | str | Unset):
    ...
    access_group_name: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        access_group_name: None | str | Unset
        if isinstance(self.access_group_name, Unset):
            access_group_name = UNSET
        else:
        ...
        if access_group_name is not UNSET:
            field_dict["access_group_name"] = access_group_name
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        def _parse_access_group_name(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        access_group_name = _parse_access_group_name(d.pop("access_group_name", UNSET))
        ...
        access_group_update_request = cls(
        ...
        access_group_update_request.additional_properties = d
        return access_group_update_request
