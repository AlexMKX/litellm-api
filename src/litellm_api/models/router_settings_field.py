...
T = TypeVar("T", bound="RouterSettingsField")



@_attrs_define
class RouterSettingsField:
    """ 
        Attributes:
            field_name (str):
            field_type (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        router_settings_field.additional_properties = d
        return router_settings_field
