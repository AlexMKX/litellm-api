...
class EmbeddingRequest:
    """ 
        Attributes:
            ...
            user (None | str | Unset):
            custom_llm_provider (EmbeddingRequestCustomLlmProviderType1 | None | str | Unset):
            litellm_call_id (None | str | Unset):
            litellm_logging_obj (EmbeddingRequestLitellmLoggingObjType0 | None | Unset):
    ...
    custom_llm_provider: EmbeddingRequestCustomLlmProviderType1 | None | str | Unset = UNSET
    litellm_call_id: None | str | Unset = UNSET
    litellm_logging_obj: EmbeddingRequestLitellmLoggingObjType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.custom_llm_provider, EmbeddingRequestCustomLlmProviderType1):
        ...
        elif isinstance(self.litellm_logging_obj, EmbeddingRequestLitellmLoggingObjType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_custom_llm_provider(data: object) -> EmbeddingRequestCustomLlmProviderType1 | None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_llm_provider_type_1 = EmbeddingRequestCustomLlmProviderType1.from_dict(data)
                ...
                pass
            return cast(EmbeddingRequestCustomLlmProviderType1 | None | str | Unset, data)
        ...
        def _parse_litellm_logging_obj(data: object) -> EmbeddingRequestLitellmLoggingObjType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                litellm_logging_obj_type_0 = EmbeddingRequestLitellmLoggingObjType0.from_dict(data)
                ...
                pass
            return cast(EmbeddingRequestLitellmLoggingObjType0 | None | Unset, data)
