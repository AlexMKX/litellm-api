...
T = TypeVar("T", bound="DefaultTeamSSOParams")



@_attrs_define
class DefaultTeamSSOParams:
    """ Default parameters to apply when a new team is automatically created by LiteLLM via SSO Groups

        Attributes:
            models (list[str] | Unset): Default list of models that new automatically created teams can access
            max_budget (float | None | Unset): Default maximum budget (in USD) for new automatically created teams
            budget_duration (None | str | Unset): Default budget duration for new automatically created teams (e.g. 'daily',
                'weekly', 'monthly')
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        default_team_sso_params.additional_properties = d
        return default_team_sso_params
