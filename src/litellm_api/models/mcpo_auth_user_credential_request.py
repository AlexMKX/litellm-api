...
T = TypeVar("T", bound="MCPOAuthUserCredentialRequest")



@_attrs_define
class MCPOAuthUserCredentialRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mcpo_auth_user_credential_request.additional_properties = d
        return mcpo_auth_user_credential_request
