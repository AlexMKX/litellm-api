...
if TYPE_CHECKING:
  from ..models.embeddings_v1_embeddings_post_body_custom_llm_provider_type_1 import EmbeddingsV1EmbeddingsPostBodyCustomLlmProviderType1
  from ..models.embeddings_v1_embeddings_post_body_litellm_logging_obj_type_0 import EmbeddingsV1EmbeddingsPostBodyLitellmLoggingObjType0





T = TypeVar("T", bound="EmbeddingsV1EmbeddingsPostBody")



@_attrs_define
class EmbeddingsV1EmbeddingsPostBody:
    """ 
        Attributes:
            model (str):
            ...
            user (None | str | Unset):
            custom_llm_provider (EmbeddingsV1EmbeddingsPostBodyCustomLlmProviderType1 | None | str | Unset):
            litellm_call_id (None | str | Unset):
            litellm_logging_obj (EmbeddingsV1EmbeddingsPostBodyLitellmLoggingObjType0 | None | Unset):
    ...
    custom_llm_provider: EmbeddingsV1EmbeddingsPostBodyCustomLlmProviderType1 | None | str | Unset = UNSET
    litellm_call_id: None | str | Unset = UNSET
    litellm_logging_obj: EmbeddingsV1EmbeddingsPostBodyLitellmLoggingObjType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.custom_llm_provider, EmbeddingsV1EmbeddingsPostBodyCustomLlmProviderType1):
        ...
        elif isinstance(self.litellm_logging_obj, EmbeddingsV1EmbeddingsPostBodyLitellmLoggingObjType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_custom_llm_provider(data: object) -> EmbeddingsV1EmbeddingsPostBodyCustomLlmProviderType1 | None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_llm_provider_type_1 = EmbeddingsV1EmbeddingsPostBodyCustomLlmProviderType1.from_dict(data)
                ...
                pass
            return cast(EmbeddingsV1EmbeddingsPostBodyCustomLlmProviderType1 | None | str | Unset, data)
        ...
        def _parse_litellm_logging_obj(data: object) -> EmbeddingsV1EmbeddingsPostBodyLitellmLoggingObjType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                litellm_logging_obj_type_0 = EmbeddingsV1EmbeddingsPostBodyLitellmLoggingObjType0.from_dict(data)
                ...
                pass
            return cast(EmbeddingsV1EmbeddingsPostBodyLitellmLoggingObjType0 | None | Unset, data)
        ...
        embeddings_v1_embeddings_post_body = cls(
            model=model,
            input_=input_,
            timeout=timeout,
            api_base=api_base,
        ...
        embeddings_v1_embeddings_post_body.additional_properties = d
        return embeddings_v1_embeddings_post_body
