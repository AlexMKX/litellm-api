...
if TYPE_CHECKING:
  from ..models.budget_new_request_model_max_budget_type_0 import BudgetNewRequestModelMaxBudgetType0





T = TypeVar("T", bound="BudgetNewRequest")



@_attrs_define
class BudgetNewRequest:
    """ 
        Attributes:
            budget_id (None | str | Unset): The unique budget id.
            ...
            model_max_budget (BudgetNewRequestModelMaxBudgetType0 | None | Unset): Max budget for each model (e.g.
    ...
    model_max_budget: BudgetNewRequestModelMaxBudgetType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.model_max_budget, BudgetNewRequestModelMaxBudgetType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_model_max_budget(data: object) -> BudgetNewRequestModelMaxBudgetType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                model_max_budget_type_0 = BudgetNewRequestModelMaxBudgetType0.from_dict(data)
                ...
                pass
            return cast(BudgetNewRequestModelMaxBudgetType0 | None | Unset, data)
        ...
        budget_new_request.additional_properties = d
        return budget_new_request
