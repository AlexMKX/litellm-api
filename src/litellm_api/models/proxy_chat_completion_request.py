...
T = TypeVar("T", bound="ProxyChatCompletionRequest")
...
class ProxyChatCompletionRequest:
    ...
    and LiteLLM-specific parameters. This replaces the previous TypedDict version.
        ...
        Attributes:
            ...
            logit_bias (None | ProxyChatCompletionRequestLogitBiasType0 | Unset):
            logprobs (bool | None | Unset):
            top_logprobs (int | None | Unset):
            max_tokens (int | None | Unset):
            n (int | None | Unset):
            presence_penalty (float | None | Unset):
            response_format (None | ProxyChatCompletionRequestResponseFormatType0 | Unset):
            seed (int | None | Unset):
            service_tier (None | str | Unset):
            stop (list[str] | None | str | Unset):
            stream_options (None | ProxyChatCompletionRequestStreamOptionsType0 | Unset):
            temperature (float | None | Unset):
            top_p (float | None | Unset):
            tools (list[ProxyChatCompletionRequestToolsType0Item] | None | Unset):
            tool_choice (None | ProxyChatCompletionRequestToolChoiceType1 | str | Unset):
            parallel_tool_calls (bool | None | Unset):
            function_call (None | ProxyChatCompletionRequestFunctionCallType1 | str | Unset):
            functions (list[ProxyChatCompletionRequestFunctionsType0Item] | None | Unset):
            user (None | str | Unset):
            stream (bool | None | Unset):
            metadata (None | ProxyChatCompletionRequestMetadataType0 | Unset):
            guardrails (list[str] | None | Unset):
            caching (bool | None | Unset):
            num_retries (int | None | Unset):
            context_window_fallback_dict (None | ProxyChatCompletionRequestContextWindowFallbackDictType0 | Unset):
    ...
    logit_bias: None | ProxyChatCompletionRequestLogitBiasType0 | Unset = UNSET
    ...
    response_format: None | ProxyChatCompletionRequestResponseFormatType0 | Unset = UNSET
    seed: int | None | Unset = UNSET
    service_tier: None | str | Unset = UNSET
    stop: list[str] | None | str | Unset = UNSET
    stream_options: None | ProxyChatCompletionRequestStreamOptionsType0 | Unset = UNSET
    temperature: float | None | Unset = UNSET
    top_p: float | None | Unset = UNSET
    tools: list[ProxyChatCompletionRequestToolsType0Item] | None | Unset = UNSET
    tool_choice: None | ProxyChatCompletionRequestToolChoiceType1 | str | Unset = UNSET
    parallel_tool_calls: bool | None | Unset = UNSET
    function_call: None | ProxyChatCompletionRequestFunctionCallType1 | str | Unset = UNSET
    functions: list[ProxyChatCompletionRequestFunctionsType0Item] | None | Unset = UNSET
    user: None | str | Unset = UNSET
    stream: bool | None | Unset = UNSET
    metadata: None | ProxyChatCompletionRequestMetadataType0 | Unset = UNSET
    guardrails: list[str] | None | Unset = UNSET
    caching: bool | None | Unset = UNSET
    num_retries: int | None | Unset = UNSET
    context_window_fallback_dict: None | ProxyChatCompletionRequestContextWindowFallbackDictType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.logit_bias, Unset):
            logit_bias = UNSET
        elif isinstance(self.logit_bias, ProxyChatCompletionRequestLogitBiasType0):
        ...
        elif isinstance(self.response_format, ProxyChatCompletionRequestResponseFormatType0):
        ...
        elif isinstance(self.stream_options, ProxyChatCompletionRequestStreamOptionsType0):
        ...
        if isinstance(self.tool_choice, Unset):
            tool_choice = UNSET
        elif isinstance(self.tool_choice, ProxyChatCompletionRequestToolChoiceType1):
        ...
        if isinstance(self.function_call, Unset):
            function_call = UNSET
        elif isinstance(self.function_call, ProxyChatCompletionRequestFunctionCallType1):
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, ProxyChatCompletionRequestMetadataType0):
        ...
        elif isinstance(self.context_window_fallback_dict, ProxyChatCompletionRequestContextWindowFallbackDictType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_logit_bias(data: object) -> None | ProxyChatCompletionRequestLogitBiasType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                logit_bias_type_0 = ProxyChatCompletionRequestLogitBiasType0.from_dict(data)
                ...
                pass
            return cast(None | ProxyChatCompletionRequestLogitBiasType0 | Unset, data)
        ...
        def _parse_response_format(data: object) -> None | ProxyChatCompletionRequestResponseFormatType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_format_type_0 = ProxyChatCompletionRequestResponseFormatType0.from_dict(data)
                ...
                pass
            return cast(None | ProxyChatCompletionRequestResponseFormatType0 | Unset, data)
        ...
        def _parse_stream_options(data: object) -> None | ProxyChatCompletionRequestStreamOptionsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                stream_options_type_0 = ProxyChatCompletionRequestStreamOptionsType0.from_dict(data)
                ...
                pass
            return cast(None | ProxyChatCompletionRequestStreamOptionsType0 | Unset, data)
        ...
        def _parse_tools(data: object) -> list[ProxyChatCompletionRequestToolsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tools_type_0_item_data in (_tools_type_0):
                    tools_type_0_item = ProxyChatCompletionRequestToolsType0Item.from_dict(tools_type_0_item_data)
                ...
                pass
            return cast(list[ProxyChatCompletionRequestToolsType0Item] | None | Unset, data)

        tools = _parse_tools(d.pop("tools", UNSET))


        def _parse_tool_choice(data: object) -> None | ProxyChatCompletionRequestToolChoiceType1 | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                tool_choice_type_1 = ProxyChatCompletionRequestToolChoiceType1.from_dict(data)
                ...
                pass
            return cast(None | ProxyChatCompletionRequestToolChoiceType1 | str | Unset, data)
        ...
        def _parse_function_call(data: object) -> None | ProxyChatCompletionRequestFunctionCallType1 | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                function_call_type_1 = ProxyChatCompletionRequestFunctionCallType1.from_dict(data)
                ...
                pass
            return cast(None | ProxyChatCompletionRequestFunctionCallType1 | str | Unset, data)

        function_call = _parse_function_call(d.pop("function_call", UNSET))


        def _parse_functions(data: object) -> list[ProxyChatCompletionRequestFunctionsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for functions_type_0_item_data in (_functions_type_0):
                    functions_type_0_item = ProxyChatCompletionRequestFunctionsType0Item.from_dict(functions_type_0_item_data)
                ...
                pass
            return cast(list[ProxyChatCompletionRequestFunctionsType0Item] | None | Unset, data)
        ...
        def _parse_metadata(data: object) -> None | ProxyChatCompletionRequestMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = ProxyChatCompletionRequestMetadataType0.from_dict(data)
                ...
                pass
            return cast(None | ProxyChatCompletionRequestMetadataType0 | Unset, data)
        ...
        def _parse_context_window_fallback_dict(data: object) -> None | ProxyChatCompletionRequestContextWindowFallbackDictType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                context_window_fallback_dict_type_0 = ProxyChatCompletionRequestContextWindowFallbackDictType0.from_dict(data)
                ...
                pass
            return cast(None | ProxyChatCompletionRequestContextWindowFallbackDictType0 | Unset, data)
        ...
        proxy_chat_completion_request = cls(
            model=model,
            messages=messages,
        ...
        proxy_chat_completion_request.additional_properties = d
        return proxy_chat_completion_request
