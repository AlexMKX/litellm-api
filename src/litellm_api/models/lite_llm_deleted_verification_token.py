...
T = TypeVar("T", bound="LiteLLMDeletedVerificationToken")
...
class LiteLLMDeletedVerificationToken:
    ...
    plus metadata captured at deletion time.
        ...
        Attributes:
            ...
            aliases (LiteLLMDeletedVerificationTokenAliases | Unset):
    ...
    aliases: LiteLLMDeletedVerificationTokenAliases | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.litellm_budget_table, LiteLLMDeletedVerificationTokenLitellmBudgetTableType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_aliases,  Unset):
            ...
            aliases = LiteLLMDeletedVerificationTokenAliases.from_dict(_aliases)
        ...
        if isinstance(_config,  Unset):
            ...
            config = LiteLLMDeletedVerificationTokenConfig.from_dict(_config)
        ...
        if isinstance(_metadata,  Unset):
            ...
            metadata = LiteLLMDeletedVerificationTokenMetadata.from_dict(_metadata)
        ...
        if isinstance(_permissions,  Unset):
            ...
            permissions = LiteLLMDeletedVerificationTokenPermissions.from_dict(_permissions)
        ...
        if isinstance(_model_spend,  Unset):
            ...
            model_spend = LiteLLMDeletedVerificationTokenModelSpend.from_dict(_model_spend)
        ...
        def _parse_litellm_budget_table(data: object) -> LiteLLMDeletedVerificationTokenLitellmBudgetTableType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                litellm_budget_table_type_0 = LiteLLMDeletedVerificationTokenLitellmBudgetTableType0.from_dict(data)
                ...
                pass
            return cast(LiteLLMDeletedVerificationTokenLitellmBudgetTableType0 | None | Unset, data)
        ...
        lite_llm_deleted_verification_token = cls(
            token=token,
            key_name=key_name,
            key_alias=key_alias,
            spend=spend,
        ...
        lite_llm_deleted_verification_token.additional_properties = d
        return lite_llm_deleted_verification_token
