...
T = TypeVar("T", bound="TagUpdateRequest")
...
class TagUpdateRequest:
    """ 
        Attributes:
            ...
            model_info (None | TagUpdateRequestModelInfoType0 | Unset):
            ...
            model_max_budget (None | TagUpdateRequestModelMaxBudgetType0 | Unset):
    ...
    model_info: None | TagUpdateRequestModelInfoType0 | Unset = UNSET
    ...
    model_max_budget: None | TagUpdateRequestModelMaxBudgetType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.model_info, Unset):
            model_info = UNSET
        elif isinstance(self.model_info, TagUpdateRequestModelInfoType0):
        ...
        elif isinstance(self.model_max_budget, TagUpdateRequestModelMaxBudgetType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_model_info(data: object) -> None | TagUpdateRequestModelInfoType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                model_info_type_0 = TagUpdateRequestModelInfoType0.from_dict(data)
                ...
                pass
            return cast(None | TagUpdateRequestModelInfoType0 | Unset, data)
        ...
        def _parse_model_max_budget(data: object) -> None | TagUpdateRequestModelMaxBudgetType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                model_max_budget_type_0 = TagUpdateRequestModelMaxBudgetType0.from_dict(data)
                ...
                pass
            return cast(None | TagUpdateRequestModelMaxBudgetType0 | Unset, data)
        ...
        tag_update_request.additional_properties = d
        return tag_update_request
