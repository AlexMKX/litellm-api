...
T = TypeVar("T", bound="ChatCompletionToolMessage")
...
class ChatCompletionToolMessage:
    """ 
        Attributes:
            role (Literal['tool']):
            content (list[ChatCompletionTextObject] | str):
            tool_call_id (str):
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_content(data: object) -> list[ChatCompletionTextObject] | str:
            try:
                ...
                pass
            return cast(list[ChatCompletionTextObject] | str, data)
        ...
        chat_completion_tool_message = cls(
            role=role,
            content=content,
            tool_call_id=tool_call_id,
        )
        ...
        chat_completion_tool_message.additional_properties = d
        return chat_completion_tool_message
