...
from ...models.body_create_file_files_post import BodyCreateFileFilesPost
...
def sync_detailed(
    *,
    ...
    Example Curl
    ```
    curl http://localhost:4000/v1/files         -H \"Authorization: Bearer sk-1234\"         -F
    purpose=\"batch\"         -F file=\"@mydata.jsonl\"
