...
def _get_kwargs(
    *,
    ...
    exclude_agent_ids: None | str | Unset = UNSET,
    ...
    json_exclude_agent_ids: None | str | Unset
    if isinstance(exclude_agent_ids, Unset):
        json_exclude_agent_ids = UNSET
    else:
        json_exclude_agent_ids = exclude_agent_ids
    params["exclude_agent_ids"] = json_exclude_agent_ids
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        exclude_agent_ids (None | str | Unset):
