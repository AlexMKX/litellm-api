...
from ...models.team_model_delete_request import TeamModelDeleteRequest
...
def sync_detailed(
    *,
    ...
    Example Request:
    ```
    curl --location 'http://0.0.0.0:4000/team/model/delete'     --header 'Authorization: Bearer sk-1234'
    ...
    Args:
        body (TeamModelDeleteRequest): Request to delete models from a team
