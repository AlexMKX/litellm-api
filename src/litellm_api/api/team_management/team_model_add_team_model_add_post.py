...
from ...models.team_model_add_request import TeamModelAddRequest
...
def sync_detailed(
    *,
    ...
    Example Request:
    ```
    curl --location 'http://0.0.0.0:4000/team/model/add'     --header 'Authorization: Bearer sk-1234'
    ...
    Args:
        body (TeamModelAddRequest): Request to add models to a team
