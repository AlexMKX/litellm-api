...
def sync_detailed(
    *,
    ...
    Args:
        model (None | str | Unset): Filter by specific model name
        status_filter (None | str | Unset): Filter by status (healthy/unhealthy)
        limit (int | Unset): Number of records to return Default: 100.
