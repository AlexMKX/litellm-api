...
from ...models.router_fields_response import RouterFieldsResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> RouterFieldsResponse | None:
    if response.status_code == 200:
        response_200 = RouterFieldsResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[RouterFieldsResponse]:
    return Response(
