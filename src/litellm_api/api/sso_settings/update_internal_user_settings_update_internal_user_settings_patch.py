...
from ...models.default_internal_user_params import DefaultInternalUserParams
...
def sync_detailed(
    *,
    ...
    Args:
        body (DefaultInternalUserParams): Default parameters to apply when a new user signs in via
            SSO or is created on the /user/new API endpoint
