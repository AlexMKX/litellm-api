...
from ...models.default_team_sso_params import DefaultTeamSSOParams
...
def sync_detailed(
    *,
    ...
    Args:
        body (DefaultTeamSSOParams): Default parameters to apply when a new team is automatically
            created by LiteLLM via SSO Groups
