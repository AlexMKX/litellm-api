...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/responses/{response_id}".format(response_id=quote(str(response_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    curl -X GET http://localhost:4000/v1/responses/litellm_poll_abc123     -H \"Authorization: Bearer
    sk-1234\"
