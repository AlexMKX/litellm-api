...
from ...models.list_fine_tuning_jobs_fine_tuning_jobs_get_custom_llm_provider_type_0 import ListFineTuningJobsFineTuningJobsGetCustomLlmProviderType0
...
def _get_kwargs(
    *,
    custom_llm_provider: ListFineTuningJobsFineTuningJobsGetCustomLlmProviderType0 | None | Unset = UNSET,
    ...
    elif isinstance(custom_llm_provider, ListFineTuningJobsFineTuningJobsGetCustomLlmProviderType0):
...
def sync_detailed(
    *,
    ...
    Args:
        custom_llm_provider (ListFineTuningJobsFineTuningJobsGetCustomLlmProviderType0 | None |
            Unset):
