...
def _get_kwargs(
    *,
    ...
    exclude_organization_ids: None | str | Unset = UNSET,
    ...
    json_exclude_organization_ids: None | str | Unset
    if isinstance(exclude_organization_ids, Unset):
        json_exclude_organization_ids = UNSET
    else:
        json_exclude_organization_ids = exclude_organization_ids
    params["exclude_organization_ids"] = json_exclude_organization_ids
...
def sync_detailed(
    *,
    ...
    Args:
        organization_ids (None | str | Unset):
        ...
        exclude_organization_ids (None | str | Unset):
