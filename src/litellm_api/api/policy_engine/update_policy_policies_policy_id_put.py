...
from ...models.policy_update_request import PolicyUpdateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/policies/{policy_id}".format(policy_id=quote(str(policy_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        policy_id (str):
        body (PolicyUpdateRequest): Request body for updating a policy.
