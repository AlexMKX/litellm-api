...
def sync_detailed(
    *,
    ...
    to control access to resources.
        ...
        * mcp_tool_permissions: Dict[str, List[str]] - Map of server ID to allowed tool names (e.g.,
    {\"server_1\": [\"tool_a\", \"tool_b\"]})
        ...
        * agent_access_groups: List[str] - List of agent access group names
        Example: {\"mcp_servers\": [\"server_1\", \"server_2\"], \"vector_stores\":
    [\"vector_store_1\"], \"agents\": [\"agent_1\"]}
    ...
    curl -L -X POST 'http://localhost:4000/customer/new'         -H 'Authorization: Bearer sk-1234'
